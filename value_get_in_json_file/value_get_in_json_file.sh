...
logResutValue() {
    ...
    echo $1 > /Users/lichaoqian/Project/CQCI/script-qbase/example/value_get_and_update/output.txt
    cat /Users/lichaoqian/Project/CQCI/script-qbase/example/value_get_and_update/output.txt
}
