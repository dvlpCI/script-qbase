...
# update_text_script_file_path=${Base_HomeDir_Absolute}/base/value_pdate_in_code/update_text_variable.sh
function_update_text_script_file_path=${Base_HomeDir_Absolute}/value_update_in_code/function_update_text_variable.sh
...
function updateText_base() {
    ...
    source "${function_update_text_script_file_path}"
...
function updateText_inJsonFile() {
    ...
    sh "${update_json_file_script_file_path}.sh" -f "${TEST_JSON_FILE_PATH}" -k "test_result" -v "${BRANCH_OUTLINES_LOG_JSON}" --skip-value-check "true"
